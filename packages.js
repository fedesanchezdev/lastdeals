...
fetch("https://fedesanchezdev.github.io/lastdeals/packages_json.json")
  .then((res) => res.json())
  .then((data) => {
    packages = data;
    showRandomPackages();
      ...
      <div class="col g-3">
        <div class="card h-100 border-1 rounded-4 position-relative" style="max-width: 200px;">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title fs-6 fw-bold mt-1 textoOculto"><small>${package.hotel}</small></h5>
            ...
            <p class="card-text text-center mt-3 fs-6"><small><small>${package.fechas}</small></small></p>
          </div>
        ...
        <div class="col">
          <div class="card h-100 border-1 rounded-4">
            ...
            <div class="card-body">
              ...
              <h5 class="card-title fs-6 fw-bold mt-1 textoOculto">${package.hotel}</h5>
